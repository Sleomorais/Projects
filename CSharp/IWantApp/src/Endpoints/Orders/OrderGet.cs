...
public class OrderGet
{
    ...
    [Authorize]
    public static async Task<IResult> Action(Guid id, OrderRequest orderRequest, HttpContext http, ApplicationDbContext context, UserManager<IdentityUser> userManager)
    {
