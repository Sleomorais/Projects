...
namespace Blog.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsyncIdAsync( [FromRoute] int id, [FromServices] BlogDataContext context)
        {
            try
            {
        ...
        public async Task<IActionResult> PostAsync([FromBody] EditorCategoryViewModel model, [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, new ResultViewModel<Category>("05XE9 - Não foi possível incluir a category"));
            }
            catch
            {
                return StatusCode(500, new ResultViewModel<Category>("05XE9 - Falha Interna no servidor"));
